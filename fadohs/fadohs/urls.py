...
urlpatterns = [
    ...
    url(r'^Predict_sentiment_and_emotion_analysis_Status/$', remoteuser.Predict_sentiment_and_emotion_analysis_Status, name="Predict_sentiment_and_emotion_analysis_Status"),
    ...
    url(r'^View_sentiment_and_emotion_analysis_type_ratio/$', serviceprovider.View_sentiment_and_emotion_analysis_type_ratio, name="View_sentiment_and_emotion_analysis_type_ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_sentiment_and_emotion_analysis_Status/$', serviceprovider.View_Prediction_Of_sentiment_and_emotion_analysis_Status, name="View_Prediction_Of_sentiment_and_emotion_analysis_Status"),
